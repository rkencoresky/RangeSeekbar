package com.android.libraryrangeseekbar.widgets;
...
import com.android.libraryrangeseekbar.R;
import com.android.libraryrangeseekbar.interfaces.OnRangeSeekbarChangeListener;
import com.android.libraryrangeseekbar.interfaces.OnRangeSeekbarFinalValueListener;
...
public class RangeSeekbar extends View {
    ...
    protected int getBarColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.RangeSeekbar_bar_color_mode, Seekbar.ColorMode.SOLID);
    }
    ...
    protected int getBarHighlightColorMode(final TypedArray typedArray) {
        return typedArray.getInt(R.styleable.RangeSeekbar_bar_highlight_color_mode, Seekbar.ColorMode.SOLID);
    }
    ...
    protected void setupBar(final Canvas canvas, final Paint paint, final RectF rect){
        ...
        if (barColorMode == Seekbar.ColorMode.SOLID) {
    ...
    protected void setupHighlightBar(final Canvas canvas, final Paint paint, final RectF rect){
        ...
        if (barHighlightColorMode == Seekbar.ColorMode.SOLID) {
